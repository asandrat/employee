...
CREATE SEQUENCE IF NOT EXISTS VACATION_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS EMPLOYEE_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS FAVORITE_VACATION_SEQUENCE START WITH 1 INCREMENT BY 1;
